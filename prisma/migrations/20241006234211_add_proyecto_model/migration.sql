...
*/
-- DropForeignKey
ALTER TABLE `Contacto` DROP FOREIGN KEY `Contacto_usuarioId_fkey`;

-- AlterTable
ALTER TABLE `Contacto` MODIFY `usuarioId` VARCHAR(191) NULL;
...
-- AddForeignKey
ALTER TABLE `Contacto` ADD CONSTRAINT `Contacto_usuarioId_fkey` FOREIGN KEY (`usuarioId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
